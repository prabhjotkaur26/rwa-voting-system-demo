...
class VotingClient {
    ...
    async selectElection(electionId) {
        ...
        try {
            ...
            console.log('Checking if user can vote in election:', electionId);
            
            // This call will check for duplicate votes if electionId is provided
            await this.apiCall('/auth/send-otp', 'POST', {
                mobileNumber: normalizedNumber,
            ...
            console.error('Error during election selection:', error);
            ...
            if (errorMsg.includes('already voted')) {
                ...
                console.error('User already voted in this election:', electionId);
            } else {
